...
(function (global) {
  ...
  var UI = {
    en: {
      ...
      pickCancel: "Cancel",
      pickCellPrompt: "Choose a tile on the board",
      mapLoading: "Still loading the maps\u2026",
      noMapForCount: "No map available for {n} players",
      ...
      idxRulesLink: "\uD83D\uDCD6 How to Play \u0026 Rules",
      selKicker: "Secret Case Files \u00b7 Blood-Cog Society",
      selSocieties: "societies",
      ...
      qrPrev: "\u2190 Previous",
      qrNext: "Next \u2192",
      qrAllReady: "Everyone ready \u00b7 Begin the hunt \u2192",
      turnOf2: "Turn:",
    ...
    th: {
      ...
      pickCancel: "ยกเลิก",
      pickCellPrompt: "เลือกช่องบนกระดาน",
      mapLoading: "ยังโหลดแผนที่ไม่เสร็จ…",
      noMapForCount: "ไม่มีแผนที่สำหรับ {n} คน",
      ...
      qrPrev: "\u2190 ก่อนหน้า",
      qrNext: "ถัดไป \u2192",
      qrAllReady: "ทุกคนพร้อม · เริ่มออกล่า →",
      turnOf2: "ตาของ",
