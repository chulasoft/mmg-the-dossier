...
(function (global) {
  ...
  var CLUE_TPL = {
    ...
    cr_espionage: { en: p => "State espionage \u2014 sits on the Rail Line \uD83D\uDE84".replace("\u2014", ":"), th: p => "จารกรรมรัฐ อยู่บนรางรถไฟ \uD83D\uDE84" },
  ...
  var UI = {
    en: {
      ...
      hitTip: "\uD83E\uDE78 A Lead \u2014 this tile matches this player's intel",
      missTip: "\u2716 No match \u2014 this tile contradicts this player's intel",
      ...
      sendingHitman: "\uD83D\uDDE1\uFE0F The hitman closes in\u2026",
    },
    th: {
      ...
      hitTip: "\uD83E\uDE78 มีร่องรอย \u2014 ช่องนี้เข้าได้กับ intel ของผู้เล่นคนนี้",
      missTip: "\u2716 ไม่ตรง \u2014 ช่องนี้ขัดกับ intel ของผู้เล่นคนนี้",
      ...
      railLabel: "รางรถไฟ",
      idxTitle: "The Dossier",
      idxSub: "เล่น 3 ถึง 5 คน \u00b7 เกมไขปริศนาบนกระดาน hex",
      idxHostTitle: "Host",
      ...
      sendingHitman: "🗡️ นักฆ่าพุ่งเข้าจู่โจม…",
    },
  };
